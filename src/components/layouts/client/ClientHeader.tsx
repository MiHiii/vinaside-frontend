    ...
    <header className='sticky top-0 z-50 w-full bg-[hsl(var(--muted))] text-[hsl(var(--muted-foreground))]'>
      <div className='mx-auto flex container items-center justify-between px-4 py-4 md:px-6'>
        ...
        <Link to='/' className='flex items-center gap-2 mr-6'>
          ...
          <span className='hidden text-xl font-bold text-[hsl(var(--muted-foreground))] md:inline-block'>Vinaside</span>
        </Link>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              {user ? (
                ...
                <Button variant='outline' className='flex gap-2 rounded-full border-gray-200 px-4 py-2'>
              ...
              {!token ? (
                ...
                <>
                  <DropdownMenuItem className='m-2 font-medium text-dark dark:hover:bg-gray-100 rounded-lg transition-colors cursor-pointer'>
                    <Link to='/wishlists' className='w-full flex items-center gap-2'>
                  ...
                  <DropdownMenuItem className='m-2 font-medium dark:hover:bg-gray-100 rounded-lg transition-colors cursor-pointer'>
                    <Link to='/profilepage' className='w-full flex items-center gap-2'>
        ...
        <div className='flex md:hidden items-center gap-2'>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              ...
              {!token ? (
                <>
                  <DropdownMenuItem onClick={openRegisterModal} className='flex items-center gap-2'>
                    <FaUserPlus /> Đăng ký
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={openModal} className='flex items-center gap-2'>
                ...
                <>
                  ...
                  {isAdmin && (
                    <DropdownMenuItem asChild>
                      <Link to='/admin' className='flex items-center gap-2 text-red-600'>
      ...
      <RegisterModal isOpen={isRegisterOpen} onClose={closeRegisterModal} onSwitchToLogin={openModal} />
