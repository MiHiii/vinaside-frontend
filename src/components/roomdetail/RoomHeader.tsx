    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-gray-300 px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          />
          <div className="text-xl font-bold leading-tight text-gray-900 text-center px-2 select-none">
            Được khách
            <br />
            yêu thích
          </div>
        </div>
        <div className="flex-1 min-w-0 text-gray-900 text-base font-medium leading-snug font-sans">
          Khách đánh giá đây là một trong những căn phòng được yêu thích nhất
          trên Vinaside
        </div>
        <div className="flex items-center gap-6 flex-1 min-w-0 justify-end">
          <div className="flex flex-col items-center">
            <span className="text-xl font-bold">
              {listing.average_rating?.toFixed(2) || "0.00"}
            </span>
