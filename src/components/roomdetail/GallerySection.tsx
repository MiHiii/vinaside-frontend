...
const GallerySection: React.FC<GallerySectionProps> = ({
  ...
  const fallbackImages = [
    ...
    "https://placehold.co/800x600?text=No+Image+2",
    "https://placehold.co/800x600?text=No+Image+3",
    "https://placehold.co/800x600?text=No+Image+4",
    "https://placehold.co/800x600?text=No+Image+5",
  ];
