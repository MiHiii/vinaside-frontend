...
import {
  ...
  clearCreateError,
  uploadListingImages,
  selectUploadListingImagesLoading,
...
const createListingSchema = z.object({
  ...
  weekend_surcharge_percent: z.preprocess(
    ...
    z
      .number()
      .min(0, "Phần trăm phụ phí phải lớn hơn hoặc bằng 0")
      .max(100, "Phần trăm phụ phí không được vượt quá 100%")
  ),
});
...
export default function CreateListing() {
  ...
  const handleInputChange = (
    field: keyof CreateListingFormData,
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleInputChange("cancel_policy", value)
              }
            >
              <SelectTrigger className="w-full h-10 text-base border border-gray-200 dark:border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
              ...
              {formData.has_weekend_surcharge && (
                <div className="space-y-2 pl-7">
                  <div className="flex items-center justify-between">
                    <Label
                      htmlFor="weekend_surcharge_percent"
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between mb-3">
              <label className="flex items-center gap-2 cursor-pointer font-semibold text-sm text-gray-700 dark:text-gray-300">
                <input
                  type="checkbox"
                  checked={
                    formData.amenities.length === amenities.length &&
                    amenities.length > 0
                  }
                  onChange={(e) => {
                    if (e.target.checked) {
            ...
            <div className="grid grid-cols-2 gap-3">
              {amenities.map((a) => (
                <label
                  key={a._id}
                  className="flex items-center gap-3 cursor-pointer p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
                >
                  <input
                    type="checkbox"
                    value={a._id}
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        setFormData((prev) => ({
                          ...prev,
                          amenities: [...prev.amenities, a._id],
                        }));
                      } else {
                        setFormData((prev) => ({
                          ...prev,
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        setFormData((prev) => ({
                          ...prev,
                          service_ids: [...prev.service_ids, s._id],
                        }));
                      } else {
                        setFormData((prev) => ({
                          ...prev,
            ...
            <div className="flex items-center justify-between mb-3">
              <label className="flex items-center gap-2 cursor-pointer font-semibold text-sm text-gray-700 dark:text-gray-300">
                <input
                  type="checkbox"
                  checked={
                    formData.safety_features.length === safetyFeatures.length &&
                  ...
                  onChange={(e) => {
                    if (e.target.checked) {
                      setFormData((prev) => ({
                        ...prev,
                        safety_features: safetyFeatures.map((sf) => sf._id),
                      }));
                    } else {
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        setFormData((prev) => ({
                          ...prev,
                          safety_features: [...prev.safety_features, sf._id],
                        }));
                      } else {
                        setFormData((prev) => ({
                          ...prev,
                          safety_features: prev.safety_features.filter(
                            (id) => id !== sf._id
                          ),
                        }));
                      }
            ...
            <div className="flex items-center justify-between mb-3">
              <label className="flex items-center gap-2 cursor-pointer font-semibold text-sm text-gray-700 dark:text-gray-300">
                <input
                  type="checkbox"
                  checked={
                    formData.house_rules_selected.length ===
                      houseRules.length && houseRules.length > 0
                  }
                  onChange={(e) => {
                    if (e.target.checked) {
                      setFormData((prev) => ({
                        ...prev,
                        house_rules_selected: houseRules.map((hr) => hr._id),
                      }));
                    } else {
                      setFormData((prev) => ({
                        ...prev,
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        ...
                        setFormData((prev) => ({
                          ...prev,
                          house_rules_selected:
                            prev.house_rules_selected.filter(
                              (id) => id !== hr._id
                            ),
                        }));
                      }
            ...
            <div className="flex items-center justify-between mb-3">
              <label className="flex items-center gap-2 cursor-pointer font-semibold text-sm text-gray-700 dark:text-gray-300">
                <input
                  type="checkbox"
                  checked={
                    formData.voucher_ids.length === vouchers.length &&
                    vouchers.length > 0
                  }
                  onChange={(e) => {
                    if (e.target.checked) {
                      setFormData((prev) => ({
                        ...prev,
                        voucher_ids: vouchers.map((v) => v._id),
                      }));
                    } else {
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        setFormData((prev) => ({
                          ...prev,
                          voucher_ids: [...prev.voucher_ids, v._id],
                        }));
                      } else {
                        setFormData((prev) => ({
                          ...prev,
                          voucher_ids: prev.voucher_ids.filter(
                            (id) => id !== v._id
                          ),
                        }));
                      }
