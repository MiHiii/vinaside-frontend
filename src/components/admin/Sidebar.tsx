...
export function Sidebar({ collapsed }: SidebarProps) {
  ...
  return (
    <aside
      className={`transition-all duration-300 bg-background min-h-screen flex flex-col rounded-xl shadow-xl m-1 sm:m-2 overflow-hidden shrink-0 ${
    ...
    >
      ...
      <div className="p-2 sm:p-3 md:p-4 text-center border-b border-gray-300">
        ...
        >
          ...
          {!collapsed && (
            <span className="text-base sm:text-lg lg:text-xl font-bold ml-1 sm:ml-2">
              Vinaside
            </span>
          )}
        </Link>
