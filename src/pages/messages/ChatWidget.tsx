...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed bottom-20 right-4 w-full max-w-sm h-[600px] bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 ease-in-out z-40",
          isOpen
